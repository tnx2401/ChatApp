    ...
    <>
      ...
      {isNotificationVisible && (
        <div className="custom-modal">
          <div className="custom-modal-content">
            <Notification isPendingRequest={isPendingRequest} />
          </div>
        </div>
      )}
      {isCreateGroup && (
      ...
      <div className="contact">
        <div className="search-container">
          ...
          <button onClick={() => handleNotification()} id="notify-button">
            <FontAwesomeIcon icon={faBell} />
            {isPendingRequest.size > 0 ? (
              <span>{isPendingRequest.size}</span>
            ) : (
              ""
            )}
          </button>
        ...
        {filteredChatList.length > 0 && (
          <p className="user-chats-text">
            <span>{chatList.length}</span> Users
          </p>
        )}
        ...
        {groupList.length > 0 && (
          <p className="group-chats-text ">
            <span>{groupList.length}</span> Group
          </p>
        )}
